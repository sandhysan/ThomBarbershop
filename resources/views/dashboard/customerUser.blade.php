...
@section('search')
  <form action="/searchUser" method="get" class="input-group">
    @csrf
...
@section('konten')
          <div class="card-body">
            <h3 class="card-title mt-2">Table Customers</h3>
            <div class="row">
              <div class="col-12">
                      ...
                      <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#staticBackdrop{{ $item->id }}"><i class="ti-eye"></i></a>
                           <a class="btn btn-warning btn-sm" href="/editViewUser/{{ $item->id }}" role="button"><i class="ti-pencil"></i></a>
                          <a class="btn btn-sm btn-danger" href="/deleteUser/{{ $item->id }}" role="button"><i class="ti-trash"></i></a>
                        </td>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="staticBackdropLabel">View Customer</h5>
