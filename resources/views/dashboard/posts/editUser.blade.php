      ...
      <div class="container">
        <form method="POST" action="/editUser">
            ...
            <div class="form-group">
              ...
              <input type="hidden" class="form-control" name="role" id="role" aria-describedby="emailHelp" value="{{ $data->role }}" readonly>
          </div>
            <input type="submit" name="submit" id="submit" value="Save" class="btn btn-primary">
            <a class="btn btn-danger" href="/customerUser">Cancel</a>
          </form>
