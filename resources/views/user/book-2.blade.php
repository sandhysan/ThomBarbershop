						...
						<form enctype="multipart/form-data" action="/savebook" method="GET">
							...
							<div class="form-group">
								<select class="form-control" name="layanan" id="layanan" onchange="onchangeLayanan()" required>
									...
									<option value="{{ $l->id }}" harga="{{ $l->harga_lyn }}" >{{ $l->nama_lyn }}</option>
									@endforeach
								</select>
							...
							<div class="form-group">
									<input class="form-control" name="harga" id="harga" type="text" value="0" placeholder="Price" readonly required>
